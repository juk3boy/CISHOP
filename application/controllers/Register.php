     ...
     public function index() {
         if (!$_POST) {
            $input = (object) $this->register->getDefaultValues();
             ...
             $input = (object) $this->input->post(null, true);
                ...
                /** ini memanggil modle vaidate dr MY_Model */
         if (!$this->register->validate()) {
             $data['title'] = 'Register';
             $data['input'] = $input;  /** ini diambil dari variable validsi diatas */
         ...
         if ($this->register->run($input)) {
            ...
            redirect(base_url());
             ...
             redirect(base_url('/register'));  /** ini akan dikembalikan ke tampilan register kembali */
         }
