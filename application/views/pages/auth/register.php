            ...
            <div class="card-body">
              ...
              <?= form_open('register', ['method' => 'POST']) ?>
                ...
                <div class="form-group">
                    ...
                    <?= form_input(['type' => 'email', 'name' => 'email', 'id' => 'email', 'value' => $input->email, 'class' => 'form-control', 'required' => true, 'autofocus' => true,  'placeholder' => 'Silahkan masukkan alamat email aktif anda disini']) ?>
