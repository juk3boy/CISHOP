    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown-1">
            <a href=" <?= base_url(); ?>masterTemplate/admin-category.html" class="dropdown-item">Kategori</a>
            <a href="<?= base_url(); ?>masterTemplate/admin-product.html" class="dropdown-item">Produk</a>
      ...
      <div class="col-sm-10 d-flex justify-content-end">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="<?= base_url(); ?>masterTemplate/login.html" class="nav-link">Login</a>
          </li>
          <li class="nav-item">
